...
fun main() {
    val n = getValueOfN()
    val matrix = MatrixFour(n, n)
    if (!matrix.isSymmetric()) throw Exception("Not symmetric!")
    val adjacencyMatrix = AdjacencyMatrixFour(matrix)
...
private class AdjacencyMatrixFour(
    private var matrix: MatrixFour
) {
